...
search_radius = 50;    %maximum extension of the data events
n = 25;                %maximum number of points in the data event
f = 0.1;               %maximum fraction of scanned training image
...
%    xt = findcoord(all_sim_pts,simul_size(1),simul_size(2));
